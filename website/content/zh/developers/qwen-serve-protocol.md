...
description: "qwen-code 守护进程的 HTTP 协议参考"
---
...
| `workspace_display_name`            | workspace 注册接受可选的 `displayName` 输入。                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `workspace_qualified_acp`           | ACP HTTP 和多 workspace runtime 均已启用，因此复数 ACP 端点可以选择次要 runtime。                                                                                                                                                                                                                                                                                                                                                                                                          |
| `workspace_qualified_rest_core`     | 复数核心 REST 路由在 `/workspaces/:workspace/...` 下可用。                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `workspace_qualified_voice`         | 多 workspace runtime 和共享 ACP/Voice WebSocket 监听器均已启用。                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `workspace_qualified_memory`        | ACP HTTP 和多 workspace runtime 均已启用。                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `extension_management_v2`           | V2 extension 管理路由已连接。                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `workspace_persisted_transcript`    | 复数转录路由已连接。                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `workspace_session_export`          | 复数活跃 session 导出路由已连接。                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `workspace_archived_session_export` | 复数归档 session 导出路由已连接。                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `client_mcp_over_ws`                | 通过 WebSocket 的客户端 MCP 传输已启用。                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `cdp_tunnel_over_ws`                | CDP 隧道通过 WebSocket 可用。                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `browser_automation_mcp`            | 浏览器自动化 MCP 已连接。                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
