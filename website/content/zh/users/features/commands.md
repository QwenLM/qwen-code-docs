...
| `/directory` | 管理多目录支持的工作空间                 | `/dir add ./src,./tests`      |
...
| `@<目录路径>`       | 递归读取目录中的所有文本文件              | `@docs/ Summarize content of this document`      |
| 单独的 `@`          | 在讨论 `@` 符号本身时使用                 | `@ What is this symbol used for in programming?` |
