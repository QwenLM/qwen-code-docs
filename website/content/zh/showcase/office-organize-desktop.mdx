---
title: "整理桌面文件"
description: "Qwen Code 整理桌面文件演示：一句话让 AI 自动识别文件类型、创建分类目录并移动杂乱文件，快速恢复清爽工作区。查看完整视频演示，学习提示词设计、文件上下文注入、工具调用和结果落地的操作步骤，适合新手快速复现并应用到真实项目。同时覆盖常见痛点、复现建议和关键词线索，帮助你减少试错时间。适合马上练习并复用。"
category: "办公提效"
features:
  - "Cowork"
...
<ShowcaseDetailMeta category="办公提效" features={["Cowork"]} model="qwen3.5-plus" />
...
进入桌面目录，启动 Qwen Code，告诉 Qwen Code 你想要如何整理桌面文件，比如按类型分类、按日期分组等。
