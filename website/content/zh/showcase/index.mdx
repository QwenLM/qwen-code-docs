...
export const scenarioVideos = [
  ...
  {
    title: "产品截图一键生成精美 PPT",
    description: "上传产品截图，Qwen Code 自动分析并生成多种风格的专业 PPT 演示文稿，商务、创意、极简风格随心切换。",
  ...
  {
    title: "一句话为开源仓库生成演示视频",
    description: "只需告诉 Qwen Code 你的仓库地址，它会自动分析项目信息并生成一段精美的演示视频，轻松为你的开源项目制作宣传素材。",
