---
title: "解决 issue"
description: "Qwen Code 解决 issue 演示：从阅读问题描述、定位相关代码到生成修复方案，展示 AI 编程助手如何参与开源协作并完成 issue 修复。查看完整视频演示，学习提示词设计、文件上下文注入、工具调用和结果落地的操作步骤，适合新手快速复现并应用到真实项目。同时覆盖常见痛点和复现建议，帮助你减少试错时间。"
category: "编程开发"
features:
  - "GitHub"
