---
title: "导出对话记录"
description: "Qwen Code 导出对话记录演示：将 AI 协作过程保存为 Markdown、HTML 或 JSON，方便复盘、归档和团队分享项目决策。查看完整视频演示，学习提示词设计、文件上下文注入、工具调用和结果落地的操作步骤，适合新手快速复现并应用到真实项目。同时覆盖常见痛点、复现建议和关键词线索，帮助你减少试错时间。"
category: "日常任务"
features:
  - "导出对话"
