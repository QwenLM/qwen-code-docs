---
title: "图片识别"
description: "Qwen Code 图片识别演示：读取 UI 设计稿、错误截图和架构图，自动理解视觉信息并转化为代码建议或问题分析。查看完整视频演示，学习提示词设计、文件上下文注入、工具调用和结果落地的操作步骤，适合新手快速复现并应用到真实项目。同时覆盖常见痛点、复现建议和关键词线索，帮助你减少试错时间。同时补充常见痛点和复现建议。"
category: "日常任务"
features:
  - "图片识别"
