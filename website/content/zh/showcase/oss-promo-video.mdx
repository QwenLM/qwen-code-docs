...
```bash
我的项目仓库是 https://github.com/username/project-name
```

### 安装视频生成 Skill

安装专门的开源项目视频生成 Skill，这个 Skill 包含了针对开源项目的视频模板和动画效果。

```bash
npx skills add QwenLM/qwen-code-examples@oss-styles
```
...
- [Remotion 视频创作（提示词方式）](/zh/showcase/remotion-prompt) — 通过自然语言描述创作视频
