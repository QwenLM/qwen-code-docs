---
title: "给开源项目做宣传视频"
description: "Qwen Code 开源项目宣传视频演示：输入 GitHub 仓库地址，让 AI 分析项目亮点并生成演示视频素材，适合发布项目和展示功能。查看完整视频演示，学习提示词设计、文件上下文注入、工具调用和结果落地的操作步骤，适合新手快速复现并应用到真实项目。同时覆盖常见痛点、复现建议和关键词线索，帮助你减少试错时间。"
category: "设计创作"
features:
  - "Skills"
  - "Remotion"
