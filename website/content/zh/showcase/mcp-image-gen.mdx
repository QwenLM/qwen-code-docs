...
<ShowcaseDetailMeta category="核心功能" features={["MCP", "图片识别"]} model="qwen3.5-plus" />

<video src="https://cloud.video.taobao.com/vod/gQg8C_5f5MGoZE9YKCyKmHlWAgXZSTMbN8WSoN7crbc.mp4" poster="https://img.alicdn.com/imgextra/i3/6000000008040/O1CN01S2cxYL29GNUmrvmzH_!!6000000008040-0-tbvideo.jpg" controls style={{width: '100%', borderRadius: '12px', marginTop: '32px', marginBottom: '32px'}} />
...
- [图片识别](/zh/showcase/image-recognition) — 让 AI 理解和分析图片内容
- [剪贴板图片粘贴](/zh/showcase/clipboard-paste) — 快速将图片粘贴到对话中
