...
| --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| User Experience                   | ✅ Terminal UI<br>✅ Support für OpenAI-Protokoll<br>✅ Einstellungen<br>✅ OAuth<br>✅ Cache-Steuerung<br>✅ Memory<br>✅ Komprimierung<br>✅ Theme                                                | Bessere UI<br>Onboarding<br>LogView<br>✅ Session<br>Berechtigungen<br>🔄 Cross-Platform-Kompatibilität<br>✅ Coding Plan<br>✅ Anthropic Provider<br>✅ Multimodale Eingaben<br>✅ Unified WebShell |
...
| Unified Web Shell       | `V0.9.0`  | Gemeinsame Browser-UI für VS Code und `qwen serve`          | User Experience                 | 2     |
