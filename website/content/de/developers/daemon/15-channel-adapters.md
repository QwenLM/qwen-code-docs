...
| Knob                                     | Effekt                                                                                                                              |
| ---------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| `sessionScope`                           | `'user'` (Sender + Chat), `'thread'` (Thread-ID oder Chat), `'chat_thread'` (Channel + chatId + threadId, für Polling-Adapter) oder `'single'` (eine gemeinsame Session pro Channel). |
