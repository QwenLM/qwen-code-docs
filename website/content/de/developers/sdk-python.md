...
| `permission_mode`          | `default`, `plan`, `auto-edit`, `auto`, `yolo`             | Genehmigungsmodus für Tool-Ausführung. `auto` lässt einen LLM-Klassifikator Tool-Aufrufe genehmigen; `yolo` genehmigt alle Tools automatisch; verwende es nur in vertrauenswürdigen oder isolierten Umgebungen. |
