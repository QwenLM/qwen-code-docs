...
<ShowcaseDetailMeta category="Kreativ-Tools" features={["Agent-Modus", "Bilderkennung"]} model="qwen3.5-plus" />
...
- [Persönliche Lebenslauf-Website erstellen](./creator-resume-site-quick.mdx) — Schnell eine persönliche Website erstellen
- [Bilderkennung](./office-image-recognition.mdx) — Bildinhalte erkennen und analysieren
