...
- [Clipboard-Bild einfügen](./office-clipboard-paste.mdx) — Screenshots schnell in das Gespräch einfügen
- [MCP-Bildgenerierung](./office-mcp-image-gen.mdx) — MCP-Tools verwenden, um Bilder zu generieren
