...
<ShowcaseDetailMeta category="Erste Schritte" features={["chat"]} model="qwen3.5-plus" />
...
- [Ein-Klick-Skript-Installation](./guide-script-install) — Qwen Code schnell über Skriptbefehle installieren
...
- [Web-Suche](./guide-web-search.mdx) — Qwen Code das Web durchsuchen lassen, um Echtzeitinformationen zur Programmierunterstützung zu erhalten
