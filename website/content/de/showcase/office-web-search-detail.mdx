...
- [Plan-Modus + Web-Suche](./guide-plan-with-search.mdx) — Plan-Modus und Web-Suche kombinieren, um komplexe Aufgaben zu bewältigen
- [Code-Lernen](./study-learning.mdx) — Suchfähigkeiten nutzen, um Open-Source-Projekte zu lernen
