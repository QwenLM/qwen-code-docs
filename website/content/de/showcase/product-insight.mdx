...
<ShowcaseDetailMeta category="Tägliche Aufgaben" features={["insight"]} model="qwen3.5-plus" />
...
- [Gesprächsverlauf exportieren](./office-export-conversation.mdx) — Wichtige Gesprächsinhalte archivieren und teilen
- [Starten Sie Ihr erstes Gespräch](./guide-first-conversation.mdx) — Schnell mit den Grundfunktionen von Qwen Code beginnen
