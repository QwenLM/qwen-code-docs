...
<ShowcaseDetailMeta category="Tägliche Aufgaben" features={["Dateioperationen"]} model="qwen3.5-plus" />
...
- [Dateien stapelweise verarbeiten](./office-batch-file-organize.mdx) — Mehrere Dateien gleichzeitig verarbeiten
- [Automatisch Wochenbericht generieren](./office-weekly-report.mdx) — Berichtsdokumente automatisch generieren
