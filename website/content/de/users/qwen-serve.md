...
| `--local-control`                       | `false`         | Teilt die authentifizierte Web-Shell auf jeder Non-Loopback-IPv4-Schnittstelle mit einem frischen pro-Prozess-Token, beschrifteten Terminal-QR-Codes, exakten Browser-Origin, einem festen Port und bestmöglicher Sleep-Inhibierung. Steht im Konflikt mit `--token`, `--allow-origin`, `--no-web`, `--port 0` und nicht-standard `--hostname`; füge `--tls-cert` + `--tls-key` hinzu für Secure-Context-Browser-APIs wie Spracheingabe.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
