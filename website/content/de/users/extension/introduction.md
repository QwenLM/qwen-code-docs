...
Da das Fallback für ältere Git-Versionen von einem Quellarchiv statt von einem Clone installiert, kann es keine Repositories installieren, die auf Submodule oder Git LFS angewiesen sind, und begrenzt Downloads auf 100 MiB komprimiert, Archive auf 100.000 Einträge / 1 GiB entpackt / 8 MiB Pfadmetadaten, einschließlich Dateien, die aus höchstens 100 Symlinks materialisiert wurden. Symlinks, die direkt auf reguläre Dateien im Repository zeigen, werden auf Systemen unterstützt, die das Erstellen von Symlinks erlauben; Windows erfordert möglicherweise den Entwicklermodus oder erhöhte Berechtigungen. Das Fallback weist Verzeichnis-, Ketten-, hängende, absolute, ausbrechende, Hard- und POSIX-Backslash-Ziel-Links zurück. Andere Agent-Plugin-Installationspfade lassen Symlinks weiterhin weg. Release-basierte Installationen werden weiterhin bevorzugt, wenn ein Repository Releases veröffentlicht.
