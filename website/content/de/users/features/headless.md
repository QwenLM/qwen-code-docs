...
| `--output-style`             | Ausgabestil für diesen Lauf (`Concise`, `Proactive`, `Explanatory`, `Learning`, der Name eines benutzerdefinierten Stils oder `default` für keinen); überschreibt `general.outputStyle`                                                                                                                                                                                                                                                                                  | `qwen -p "query" --output-style Concise`                                 |
