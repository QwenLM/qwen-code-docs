...
- Überprüfe, dass `groupPolicy` auf `"allowlist"`, `"pairing"` oder `"open"` gesetzt ist (Standard ist `"disabled"`)
- Wenn du `"pairing"` verwendest, stelle sicher, dass die Pairing-Anfrage der Gruppe genehmigt wurde
