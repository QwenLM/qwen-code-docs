...
> Der Zed Editor bietet nativen Support für KI-Coding-Assistenten über das Agent Client Protocol (ACP). Diese Integration ermöglicht es Ihnen, Qwen Code direkt innerhalb der Zed-Oberfläche mit Echtzeit-Code-Vorschlägen zu nutzen.
...
3. Klicke in Zed auf die **Einstellungsschaltfläche** in der oberen rechten Ecke, wähle **"Agent hinzufügen"**, wähle **"Benutzerdefinierten Agent erstellen"** und füge folgende Konfiguration hinzu:
