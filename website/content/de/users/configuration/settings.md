...
| `--acp`                      |       | Aktiviert ACP-Modus (Agent Client Protocol). Nützlich für IDE-/Editor-Integrationen wie [Zed](../integration-zed).                                                                     |                                        | Stabil. Ersetzt das veraltete Flag `--experimental-acp`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
