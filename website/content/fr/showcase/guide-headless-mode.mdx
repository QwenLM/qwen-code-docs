...
<ShowcaseDetailMeta category="Guide de démarrage" features={["Headless"]} model="qwen3.5-plus" />
...
- [Authentification et connexion](./guide-authentication.mdx) — Comprendre le processus d'authentification de Qwen Code, compléter rapidement la connexion au compte
- [Fichier de configuration Agents](./guide-agents-config.mdx) — Personnaliser le comportement de l'IA via les fichiers MD Agents
