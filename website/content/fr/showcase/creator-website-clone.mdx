...
<ShowcaseDetailMeta category="Outils créatifs" features={["Mode Agent", "Reconnaissance d'images"]} model="qwen3.5-plus" />
...
- [Créer un site web de CV personnel](./creator-resume-site-quick.mdx) — Créer rapidement un site web personnel
- [Reconnaissance d'images](./office-image-recognition.mdx) — Reconnaître et analyser le contenu des images
