...
<ShowcaseDetailMeta category="Tâches quotidiennes" features={["MCP", "Génération d'images"]} model="qwen3.5-plus" />
...
- [Reconnaissance d'images](./office-image-recognition.mdx) — Laisser l'IA comprendre et analyser le contenu des images
- [Coller une image du presse-papiers](./office-clipboard-paste.mdx) — Coller rapidement des images dans la conversation
