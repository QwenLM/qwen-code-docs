...
<ShowcaseDetailMeta category="Guide de démarrage" features={["Mode Plan", "Recherche Web"]} model="qwen3.5-plus" />
...
- [Recherche Web](./guide-web-search.mdx) — Obtenir les dernières documentations techniques et solutions en temps réel
- [Bailian Coding Plan](./guide-bailian-coding-plan.mdx) — Capacités de planification exclusives pour la plateforme Bailian
