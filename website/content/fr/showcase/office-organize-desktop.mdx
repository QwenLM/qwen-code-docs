...
- [Traitement de fichiers en lot](./office-batch-file-organize.mdx) — Traiter plusieurs opérations de fichiers à la fois
- [Écrire un fichier en une phrase](./office-write-file.mdx) — Créer rapidement de nouveaux fichiers
