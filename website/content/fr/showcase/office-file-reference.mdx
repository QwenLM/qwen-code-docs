...
<ShowcaseDetailMeta category="Guide de démarrage" features={["Référence de fichier"]} model="qwen3.5-plus" />
...
- [Apprentissage du code](./study-learning.mdx) — Cloner des dépôts open source et apprendre à comprendre le code
