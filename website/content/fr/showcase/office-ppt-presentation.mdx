...
<ShowcaseDetailMeta category="Tâches quotidiennes" features={["Mode Agent"]} model="qwen3.5-plus" />
...
- [Générer automatiquement un rapport hebdomadaire](./office-weekly-report.mdx) — Collecter automatiquement des données et générer des rapports
- [Écrire un fichier en une phrase](./office-write-file.mdx) — Créer rapidement divers documents
