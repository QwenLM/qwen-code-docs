...
- [Fonction de référence @file](./office-file-reference.mdx) — Référencer des fichiers de projet via @file dans les conversations, permettant à l'IA de comprendre précisément votre contexte de code
