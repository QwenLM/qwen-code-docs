...
<ShowcaseDetailMeta category="Outils créatifs" features={["Skills", "Web Search"]} model="qwen3.5-plus" />
...
- [Lire des articles](./study-read-paper.mdx) — Comprendre en profondeur le contenu académique
- [Écrire dans un fichier en une phrase](./office-write-file.mdx) — Créer rapidement divers documents
