...
2.  **Historique de la conversation :** La totalité de la conversation que vous avez eue avec l'agent jusqu'à ce point est sauvegardée.
...
Pour restaurer votre projet à partir d'un checkpoint spécifique, utilisez le fichier de checkpoint provenant de la liste :
...
Après avoir exécuté la commande, vos fichiers et la conversation seront immédiatement restaurés à l'état dans lequel ils se trouvaient lors de la création du checkpoint, et l'invite originale de l'outil réapparaîtra.