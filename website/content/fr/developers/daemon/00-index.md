...
- **Enfant ACP** - le processus enfant `qwen --acp` qui héberge le runtime de l'agent d'un workspace. Les tentatives de production préchauffent le bridge principal et réessayent à la première utilisation après échec ; un secondaire fiable démarre son enfant à la demande, tandis qu'un secondaire non fiable ne le fait pas. Le bridge propriétaire multiplexe les sessions et les clients sur cet enfant.
