...
| Capacités        | `SERVE_PROTOCOL_VERSION = 'v1'` ; 158 tags enregistrés ; 45 tags conditionnels.                                                                                                                      | [`11`](./11-capabilities-versioning.md)                                                                       |
...
| Consommateur daemon du Web Shell       | `packages/web-shell/client/daemon/` consomme le store de transcript du SDK via des providers et des adapters React.                                                         | [`14`](./14-cli-tui-adapter.md), [`../daemon-client-adapters/web-shell.md`](../daemon-client-adapters/web-ui.md)                                 |
