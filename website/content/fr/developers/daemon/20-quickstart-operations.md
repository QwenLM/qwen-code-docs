...
| `--memory-budget-mb <n>`                | integer dans `[1024, 1048576]` | 50% de la mémoire cgroup/hôte                    | Observation seule                        | Budget mémoire total pour l'arbre de processus du démon, plafonné à la mémoire disponible résolue. Rapporté sous `limits.memory` ; ne dimensionne aucun enfant.                                                                                                                                                       |
