...
| `packages/web-shell`                                                                                             | L'UI navigateur et l'adaptateur React du démon construits sur le SDK TypeScript.                                                                                                                             |
...
| `packages/desktop-shell`, `packages/vscode-ide-companion`, `packages/chrome-extension`, `packages/zed-extension` | Surfaces produit et éditeur qui adaptent Qwen Code à leurs environnements hôtes.                                                                                                                     |
...
`packages/web-shell` construit une couche d'état React et une UI navigateur sur le client du démon. D'autres clients, dont les intégrations IDE et les canaux gérés par le démon, réutilisent les mêmes contrats SDK et événements au lieu d'importer le code d'implémentation du serveur.
