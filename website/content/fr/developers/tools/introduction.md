...
2.  La CLI transmet le prompt au core.
...
- **[Outils de système de fichiers](./file-system.md) :** Pour interagir avec les fichiers et les répertoires (lecture, écriture, listage, recherche, etc.).
...
- **[Outil de mémoire](./memory.md) (`save_memory`) :** Pour enregistrer et rappeler des informations entre les sessions.
- **[Outil d'écriture de tâches](./todo-write.md) (`todo_write`) :** Pour créer et gérer des listes de tâches structurées pendant les sessions de codage.
...
- **[Serveurs MCP](./mcp-server.md)** : Les serveurs MCP font office de pont entre le modèle et votre environnement local ou d'autres services comme les API.
  ...
  - **[Configurations d'exemple MCP](../mcp-example-configs.md)** : Configurations prêtes à l'emploi pour des scénarios courants
