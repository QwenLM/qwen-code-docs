...
Voici un exemple de script proxy pouvant être utilisé avec la variable d'environnement `QWEN_SANDBOX_PROXY_COMMAND`. Ce script autorise uniquement les connexions `HTTPS` vers `example.com:443` et refuse toutes les autres requêtes.
