...
| `Ctrl+V`                                           | Coller le contenu du presse-papiers. Si le presse-papiers contient une image, celle-ci sera sauvegardée et une référence sera insérée dans l'invite. |
| `Ctrl+W` / `Meta+Retour arrière` / `Ctrl+Retour arrière` | Supprimer le mot à gauche du curseur.                                                                                               |
| `Ctrl+X` / `Meta+Entrée`                           | Ouvrir l'entrée actuelle dans un éditeur externe.                                                                                  |
