...
La mise en cache réduit le coût du préfixe que chaque requête transporte. Pour rendre ce préfixe plus petit dès le départ — moins de schémas d'outils résidents, fichiers de contexte plus petits — consultez [Coût du contexte résident](./context-cost.md) ; les deux se combinent.
