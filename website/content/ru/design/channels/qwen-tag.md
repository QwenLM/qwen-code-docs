...
> **Историческая запись решений.** Предпосылка этого черновика «один процесс на
> рабочее пространство / один демон на рабочее пространство» заменена. Именованные
> управляемые демоном каналы теперь группируются по владеющему рабочему пространству
> с одним воркером на владеющий рантайм; `--channel all` остается только для
> основного. Единый глобальный токен и отсутствие идентификации конкретного человека
> остаются текущими ограничениями. См.
> [`../daemon-multi-workspace-hardening.md`](../daemon-multi-workspace-hardening.md).

**Статус:** Исторический черновик (v2)
**Дата:** 2026-06-25
**Автор:** (qwen-code)
