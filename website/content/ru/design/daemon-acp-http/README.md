...
> **Историческая запись решения.** Этот дизайн предшествует зарегистрированным
> мульти-воркспейсным рантаймам. Его ссылки на bearer-токен плюс привязку к
> одному воркспейсу как границу доверия устарели: теперь один bearer-токен
> покрывает все зарегистрированные воркспейсы, а доверие к воркспейсу — это
> гейт выполнения, а не ACL. Текущий контракт владения и изоляции см. в
