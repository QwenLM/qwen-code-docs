...
<ShowcaseDetailMeta category="Инструменты для творчества" features={["Skills", "Web Search"]} model="qwen3.5-plus" />
...
- [Чтение статей](./study-read-paper.mdx) — Глубокое понимание академического контента
- [Запись в файл](./office-write-file.mdx) — Быстрое создание различных документов
