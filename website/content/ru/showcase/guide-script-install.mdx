...
<ShowcaseDetailMeta category="Руководство по началу работы" features={["Установка"]} model="qwen3.5-plus" />
...
- [Настройка API](./guide-api-setup.mdx) — Настройте ключи API и параметры модели для персонализации опыта программирования с ИИ
- [Интерфейс интеграции VS Code](./guide-vscode-integration.mdx) — Используйте все функции Qwen Code в VS Code
