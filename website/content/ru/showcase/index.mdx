...
export const heroVideo = {
  ...
  description: "Познакомьтесь с Qwen Code за 30 секунд: от установки до разговора и выполнения первой задачи. Ваш ИИ-партнёр по программированию, превращающий идеи в реальность одной фразой.",
