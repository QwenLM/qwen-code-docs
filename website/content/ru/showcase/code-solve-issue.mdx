...
<ShowcaseDetailMeta category="Программирование" features={["GitHub"]} model="qwen3.5-plus" />
...
- [Изучение кода](./study-learning.mdx) — Клонирование open source репозиториев и понимание кода
- [Ревью PR](./code-pr-review.mdx) — Позвольте ИИ проверить ваши Pull Request для повышения качества кода
