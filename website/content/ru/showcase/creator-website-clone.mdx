...
<ShowcaseDetailMeta category="Инструменты для творчества" features={["Agent Mode"]} model="qwen3.5-plus" author="Qwen Code Team" />
...
<img src="https://gw.alicdn.com/imgextra/i4/O1CN01FUQtA51YIzygQQhLT_!!6000000003037-2-tps-2768-1552.png" alt="" style={{width: '70%', borderRadius: '12px', marginTop: '32px', marginBottom: '32px', display: 'block', marginLeft: 'auto', marginRight: 'auto'}} />
