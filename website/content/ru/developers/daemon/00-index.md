...
| Быстрый старт / эксплуатация | Описаны кратчайший путь запуска, рецепты запуска, проверки через curl, поведение аутентификации Web Shell, разделение маршрутов, поведение при завершении работы и рецепты встроенного вызова. | [`20`](./20-quickstart-operations.md) |
