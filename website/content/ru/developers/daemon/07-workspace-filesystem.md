...
| Теги возможностей                                 | `workspace_file_read`, `workspace_file_bytes`, `workspace_file_write`, `workspace_file_upload` | См. [`11-capabilities-versioning.md`](./11-capabilities-versioning.md).                      |
