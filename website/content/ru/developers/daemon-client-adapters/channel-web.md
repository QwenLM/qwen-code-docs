...
- один демон на пользователя или принципала безопасности
- только демо-режим для одного пользователя
...
- Диагностические данные только для чтения для MCP, навыков, провайдеров и окружения.