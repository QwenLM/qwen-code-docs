...
### 1. Когда вы открываете Issue: `Qwen Triage`
...
- **Файл рабочего процесса**: `.github/workflows/qwen-triage.yml`
- **Когда запускается**: Сразу после создания, редактирования или повторного открытия issue, или когда координатор вручную запрашивает триаж.
- **Что делает**:
...
- **Что вам следует делать**:
  ...
  - Координаторы могут написать `@qwen-code /triage`, чтобы запустить триаж повторно.
