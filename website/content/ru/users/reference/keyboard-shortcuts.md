...
| ------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| `!`                                               | Переключить режим оболочки, когда поле ввода пусто.                                                                                 |
...
| `Ctrl+V`                                          | Вставить содержимое буфера обмена. Если буфер содержит изображение, оно будет сохранено, а ссылка на него вставлена в команду.       |
...
| (многозначные числа) | Для элементов с номерами больше 9 нажимайте цифры быстро друг за другом, чтобы выбрать соответствующий элемент. |
