...
Это руководство покажет вам, как создавать, использовать и управлять навыками агента в **Qwen Code**. Навыки — это модульные возможности, которые расширяют эффективность модели с помощью организованных папок, содержащих инструкции (и при необходимости скрипты/ресурсы).

> [!note]
>
> В настоящее время навыки находятся в стадии **эксперимента** и должны быть включены с помощью флага `--experimental-skills`.
...
## Делитесь навыками с вашей командой
