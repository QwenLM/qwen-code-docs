...
Кэширование снижает стоимость префикса, который несёт каждый запрос. Чтобы уменьшить сам префикс — меньше резидентных схем инструментов, файлы контекста меньшего объёма — см. [Стоимость резидентного контекста](./context-cost.md); эти два подхода дополняют друг друга.
