...
Рабочий пример прокси с allowlist-логикой см.: [Example Proxy Script](/developers/examples/proxy-script).
...
export SANDBOX_SET_UID_GID=false  # Отключить маппинг UID/GID
```
