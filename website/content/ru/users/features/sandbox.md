...
Рабочий пример прокси-скрипта со списком разрешенных адресов можно найти здесь: [Пример прокси-скрипта](/developers/examples/proxy-script).
...
- [Устранение неполадок](../support/troubleshooting): Общие рекомендации по устранению проблем.