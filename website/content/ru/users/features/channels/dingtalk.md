...
Установите `"atSender": true`, чтобы бот @упоминал участника, чьё групповое сообщение вызвало его ответ. По умолчанию эта опция выключена и применяется только к ответам агента с ID сотрудника DingTalk. Ответы с упоминанием используют обычный текст, чтобы @ был виден; ответы без упоминания используют форматирование Markdown.
