...
| -------------------------------- | ------------------------------ | -------------------------------------------------------------------------------------------------------------- |
| Агенты ревью (Шаг 3)             | 16 (+0-2)                      | Работают параллельно; Агент 1e только когда дифф сигнализирует о wrapping-типе (15 без него); кросс-репо пропускает Агентов 1c и 7 (14), локальные/файловые пропускают Агента 0 (15)    |
...
| **Всего**                        | **~19-30 (~17-29)**            | 3A в том же репо: ~19-30 (типично ~19-21); кросс-репо или локальные/файловые: ~17-29; на один меньше, когда Агент 1e не включён в ростер; 3B масштабируется с чанками (см. DESIGN.md) |
