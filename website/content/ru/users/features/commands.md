...
| ------------ | ----------------------------------------------------------- | ------------------------------------------------- |
| `/review`    | Проверка изменений кода с помощью 9 параллельных review-агентов | `/review`, `/review 123`, `/review 123 --comment` |
...
### 1.9 Информация, настройки и помощь
