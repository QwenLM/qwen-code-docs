...
> [!note]
> **Режимы отображения с разделением панелей запланированы на будущее.** Мы планируем поддержку макетов с разделением панелей на основе tmux и iTerm2, где каждый агент получит собственную терминальную панель для настоящего просмотра бок о бок. В настоящее время доступно только переключение вкладок в рамках одного процесса.
...
- **Лёгкое делегирование**: [Субагенты](/users/features/sub-agents) обрабатывают узкие подзадачи в рамках вашей сессии — лучше подходят, когда сравнение моделей не требуется
