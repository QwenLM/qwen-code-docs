...
- **Усилие рассуждений**: Выберите Default, Low, Medium, High, Extra high или Max в опциях сессии агента; каждый провайдер сопоставляет или ограничивает запрошенный уровень для активной модели
- **Использование контекста**: Отслеживание текущего заполнения контекстного окна во время работы Qwen Code
