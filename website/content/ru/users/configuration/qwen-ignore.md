...
Когда вы добавляете путь в файл `.qwenignore`, инструменты, которые учитывают этот файл, будут исключать соответствующие файлы и каталоги из своих операций. Например, когда вы используете команду [`read_many_files`](/developers/tools/multi-file), любые пути, указанные в вашем файле `.qwenignore`, будут автоматически исключены.
...
| Шаг                      | Описание                                                   |
| ------------------------ | ---------------------------------------------------------- |
| **Включить .qwenignore** | Создайте файл с именем `.qwenignore` в корневом каталоге проекта |
