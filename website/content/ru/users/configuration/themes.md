...
- Пользовательские темы можно задавать на уровне пользователя, проекта или системы и они следуют тому же [порядку приоритета конфигурации](../configuration/settings), что и другие настройки.
