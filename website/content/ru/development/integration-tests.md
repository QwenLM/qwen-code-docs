...
Если вывод сохраняется, test runner выведет путь к уникальному каталогу для этого запуска теста.
...
Вы можете добавить флаг `:fix` к команде, чтобы автоматически исправить все возможные ошибки линтинга:
