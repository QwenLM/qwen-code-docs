...
| 표면                               | 구현 앵커                                                                                                                                                                                                                                                          | 주요 문서                                                                                                            |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| 부트스트랩 및 HTTP 조합            | `packages/cli/src/serve/run-qwen-serve.ts`, `packages/cli/src/serve/server.ts`, `packages/cli/src/serve/routes/health.ts`, `packages/cli/src/serve/web-shell-static.ts`                                                                                                | [`02`](./02-serve-runtime.md), [`20`](./20-quickstart-operations.md)                                                  |
...
| 공유 UI 트랜스크립트 레이어        | `DaemonUiEventType`, `DaemonSessionProvider`, `packages/web-shell/client/daemon/`                                                                                                                                                                                          | [`13`](./13-sdk-daemon-client.md), [`14`](./14-cli-tui-adapter.md), [`../daemon-ui/README.md`](../daemon-ui/README.md) |
...
| 기능           | `SERVE_PROTOCOL_VERSION = 'v1'`; 등록된 태그와 조건부 태그는 공식 레지스트리에서 정의됩니다.                                                                                                                                                                               | [`11`](./11-capabilities-versioning.md)                                                                |
...
| Web Shell 데몬 소비자            | `packages/web-shell/client/daemon/`는 React 제공자와 어댑터를 통해 SDK 트랜스크립트 저장소를 소비합니다.                                                        | [`14`](./14-cli-tui-adapter.md), [`../daemon-client-adapters/web-shell.md`](../daemon-client-adapters/web-shell.md) |
...
| 퀵스타트 / 운영     | 최단 시작 경로, 시작 레시피, curl 검사, Web Shell 인증 동작, 라우트 분할, 종료 동작, 임베디드 호출 레시피가 포함되어 있습니다.                     | [`20`](./20-quickstart-operations.md) |
