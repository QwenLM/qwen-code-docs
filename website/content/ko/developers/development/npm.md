...
다가오는 기능에 대한 얼리 액세스를 위해 매주 화요일 17:00 UTC에 제공되는 Preview 릴리스.

### Nightly 릴리스

최신 개발 테스트를 위해 매일 21:00 UTC에 제공되는 Nightly 릴리스.

## 자동화 릴리스 스케줄

- **Nightly**: 매일 21:00 UTC
- **Preview**: 매주 화요일 17:00 UTC
...
1.  태그(`vX.Y.Z-patch.1`): 이 태그는 릴리스하려는 stable 코드가 포함된 main의 원본 커밋을 올바르게 가리킵니다. 이것이 핵심입니다. 이 태그를 체크아웃하는 사람은 누구나 게시된 정확한 코드를 얻게 됩니다.
