...
- [Plan Mode + Web Search](./guide-plan-with-search.mdx) — Combine Plan Mode with Web Search to handle complex tasks
- [Read Papers](./study-read-paper.mdx) — Let AI help you read and understand academic papers, extracting key information
