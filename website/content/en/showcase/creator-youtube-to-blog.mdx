...
<ShowcaseDetailMeta category="Creator Tools" features={["Skills", "Web Search"]} model="qwen3.5-plus" />
...
- [Read Papers](./study-read-paper.mdx) — Deeply understand academic content
- [Write to File with One Sentence](./office-write-file.mdx) — Quickly create various documents
