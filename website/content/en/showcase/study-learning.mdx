...
<ShowcaseDetailMeta category="Learning & Research" features={["Web Search"]} model="qwen3.5-plus" />
...
- [PR Review](./code-pr-review.mdx) — Let AI help you review Pull Requests to improve code quality
