...
export const scenarioVideos = [
  ...
  {
    title: "Generate Beautiful PPT from Product Screenshot",
    description: "Upload a product screenshot and Qwen Code automatically analyzes it to generate professional PPT presentations in multiple styles — business, creative, and minimalist styles at your fingertips.",
