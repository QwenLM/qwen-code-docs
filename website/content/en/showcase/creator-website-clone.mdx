...
<ShowcaseDetailMeta category="Creator Tools" features={["Agent Mode", "Image Recognition"]} model="qwen3.5-plus" />
...
- [Create a Personal Resume Website](./creator-resume-site-quick.mdx) — Quickly create a personal website
- [Image Recognition](./office-image-recognition.mdx) — Recognize and analyze image content
