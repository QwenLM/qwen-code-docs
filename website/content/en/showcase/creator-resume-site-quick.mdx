...
<ShowcaseDetailMeta category="Creator Tools" features={["Skills"]} model="qwen3.5-plus" />
...
- [Replicate Your Favorite Website](./creator-website-clone.mdx) — Give Qwen Code a screenshot and tell it which website you want to replicate
- [Write to File with One Sentence](./office-write-file.mdx) — Tell Qwen Code what content to write and it will create and write files for you
- [Remotion Video Creation](./creator-remotion-video.mdx) — Use natural language descriptions with the Remotion Skill to generate video content
