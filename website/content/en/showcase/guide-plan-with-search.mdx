...
<ShowcaseDetailMeta category="Getting Started" features={["Plan Mode", "Web Search"]} model="qwen3.5-plus" />
...
- [Web Search](./guide-web-search.mdx) — Get the latest technical documentation and solutions in real time
- [Bailian Coding Plan](./guide-bailian-coding-plan.mdx) — Exclusive planning capabilities for the Bailian platform
