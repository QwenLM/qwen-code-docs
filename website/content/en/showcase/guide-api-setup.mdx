...
<ShowcaseDetailMeta category="Getting Started" features={["Settings", "API"]} model="qwen3.5-plus" />
...
If you are a Bailian Coding Plan mode user, please refer to the [Bailian Coding Plan API Configuration Guide](./guide-bailian-coding-plan.mdx) to obtain the API Key and configure the model.
...
- [Bailian Coding Plan Mode](./guide-bailian-coding-plan.mdx) — Configure to use Bailian Coding Plan, multiple model selection, improve the completion quality of complex tasks
