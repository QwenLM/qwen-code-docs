...
<ShowcaseDetailMeta category="Daily Tasks" features={["Agent Mode"]} model="qwen3.5-plus" />
...
- [Automatically Generate Weekly Report](./office-weekly-report.mdx) — Automatically collect data and generate reports
- [Write File with One Sentence](./office-write-file.mdx) — Quickly create various documents
