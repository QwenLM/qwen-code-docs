...
<ShowcaseDetailMeta category="Getting Started" features={["Headless"]} model="qwen3.5-plus" />
...
- [Authentication Login](./guide-authentication.mdx) — Understand Qwen Code's authentication process, quickly complete account login
- [Agents Configuration File](./guide-agents-config.mdx) — Customize AI behavior through Agents MD files
