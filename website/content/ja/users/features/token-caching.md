...
キャッシュにより、各リクエストが持つプレフィックスの価格が下がります。そもそもそのプレフィックスを小さくするには — 常駐するツールスキーマを減らす、コンテキストファイルを小さくする — [Resident Context Cost](./context-cost.md) を参照してください。両者は組み合わせて使えます。
