...
| 設定                 | 型      | 説明                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | デフォルト |
| -------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| `review.attribution` | boolean | `/review` が投稿するレビュー本文およびインラインコメントに、モデル名と CLI バージョン（例: `_— qwen3-coder via Qwen Code /review (v0.21.2)_`）を記述した帰属フッターを追加します。無効にすると、AI 帰属なしでレビューを投稿できます。フッターがオフの場合でも、事前送信の重複検出は同じ GitHub アカウントによる以前の投稿を認識しますが、他のアカウントによるフッターなしの投稿は検出できません。                                  | `true`     |
