...
- **推論の努力量**: エージェントのセッションオプションから Default、Low、Medium、High、Extra high、または Max を選択できます。各プロバイダーはアクティブなモデルに対して要求されたティアをマッピングまたはクランプします
- **コンテキスト使用状況**: Qwen Code の動作中に現在のコンテキストウィンドウの占有状況を確認可能
