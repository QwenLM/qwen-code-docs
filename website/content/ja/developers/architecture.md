...
| `packages/web-shell`                                                                                       | TypeScript SDK 上に構築されたブラウザ UI とデーモン React アダプター。                                                                                                                               |
...
- `packages/web-shell` はデーモン状態を React プロバイダーとフックに適応させ、ブラウザ体験を提供します。
...
`packages/web-shell` はデーモンクライアント上に React 状態レイヤーとブラウザ UI を構築します。IDE 統合やデーモン管理チャネルを含む他のクライアントも、サーバー実装コードをインポートする代わりに、同じ SDK とイベント契約を再利用します。
