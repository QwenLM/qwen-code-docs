...
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| ブートストラップと HTTP アセンブリ         | `packages/cli/src/serve/run-qwen-serve.ts`, `packages/cli/src/serve/server.ts`, `packages/cli/src/serve/routes/health.ts`, `packages/cli/src/serve/web-shell-static.ts`                                                                                                | [`02`](./02-serve-runtime.md), [`20`](./20-quickstart-operations.md)                                                   |
...
| 共有 UI トランスクリプトレイヤー          | `DaemonUiEventType`, `DaemonSessionProvider`, `packages/web-shell/client/daemon/`                                                                                                                                                                                           | [`13`](./13-sdk-daemon-client.md), [`14`](./14-cli-tui-adapter.md), [`../daemon-ui/README.md`](../daemon-ui/README.md) |
...
| ケイパビリティ  | `SERVE_PROTOCOL_VERSION = 'v1'`。登録済みタグと条件付きタグは、正式なレジストリによって定義されます。                                                                                             | [`11`](./11-capabilities-versioning.md)                                                                       |
...
| Web Shell daemon コンシューマー       | `packages/web-shell/client/daemon/` は、Reactプロバイダーとアダプターを介してSDKトランスクリプトストアを消費します。                                                         | [`14`](./14-cli-tui-adapter.md), [`../daemon-client-adapters/web-shell.md`](../daemon-client-adapters/web-shell.md)                                 |
