...
- **[Web 検索ツール](./web-search.md) (`web_search`)**: Web を検索するため。サポートされるプロバイダーがバックエンドとして利用可能な場合、起動時に使用できます。
...
- **[プランモード終了ツール](./exit-plan-mode.md) (`exit_plan_mode`)**: プランモードを終了し実装に進むため
