...
| `Ctrl+S`       | 長いレスポンスを完全に表示できるようにし、切り捨てを無効にします。端末のスクロールバックを使用して 전체出力を表示してください。 |
| `Ctrl+T`       | ツールの説明表示を切り替えます。                                                                                          |
...
| ショートカット  | 説明                                   |
| --------------- | -------------------------------------- |
| `Down Arrow`    | サジェッションを下に移動する。         |
| `Tab` / `Enter` | 選択中のサジェッションを確定する。     |
| `Up Arrow`      | サジェッションを上に移動する。         |
