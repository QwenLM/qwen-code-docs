...
<ShowcaseDetailMeta category="クリエイターツール" features={["Skills"]} model="qwen3.5-plus" />
...
- [好きなウェブサイトを一言で再現](./creator-website-clone.mdx) — Qwen Code にスクリーンショットを渡して再現したいサイトを伝える
- [一言でファイルに書き込む](./office-write-file.mdx) — Qwen Code に書き込む内容を伝えてファイルを作成・書き込みさせる
- [Remotion 動画制作](./creator-remotion-video.mdx) — Remotion スキルで動画コンテンツを生成する
