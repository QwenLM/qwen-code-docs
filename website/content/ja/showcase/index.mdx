...
export const heroVideo = {
  title: "Qwen Code 紹介",
  description: "30秒で Qwen Code のコア機能を学ぶ：インストールから会話、最初のタスクの完了まで。アイデアから実装まで、一言で完了する AI コーディングパートナー。\nこのビデオは Qwen Code + oss-styles Remotion スキルを使用してワンクリックで生成されました。",
...
export const scenarioVideos = [
  ...
  {
    title: "製品スクリーンショットから美しい PPT を生成",
    description: "製品スクリーンショットをアップロードすると、Qwen Code が自動的に分析し、ビジネス・クリエイティブ・ミニマルなど複数のスタイルでプロフェッショナルな PPT を生成。",
  ...
  {
    title: "一言でオープンソースリポジトリのデモ動画を生成",
    description: "Qwen Code にリポジトリの URL を伝えるだけで、プロジェクト情報を自動分析し、洗練されたデモ動画を生成。オープンソースプロジェクトのプロモーション素材を手軽に作成。",
