...
<ShowcaseDetailMeta category="入門ガイド" features={["プランモード", "Web検索"]} model="qwen3.5-plus" />
...
- [Web検索](./guide-web-search.mdx) — 最新の技術ドキュメントとソリューションをリアルタイムで取得
- [百煉Coding Plan](./guide-bailian-coding-plan.mdx) — 百煉プラットフォーム専用の計画能力
