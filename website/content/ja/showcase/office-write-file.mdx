...
<ShowcaseDetailMeta category="日常タスク" features={["ファイル操作"]} model="qwen3.5-plus" />
...
- [ファイルを一括処理](./office-batch-file-organize.mdx) — 複数のファイルを一度に処理
- [週報を自動生成](./office-weekly-report.mdx) — レポートドキュメントを自動生成
