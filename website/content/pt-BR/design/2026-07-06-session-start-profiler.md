...
A saída exclui intencionalmente IDs de sessão, prompts, respostas do modelo, saída de hooks, nomes de ferramentas, caminhos de arquivo e diretórios de trabalho. Os nomes dos estágios são strings estáticas pertencentes ao código.
