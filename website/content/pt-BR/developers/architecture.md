...
| `packages/desktop-shell`, `packages/vscode-ide-companion`, `packages/chrome-extension`, `packages/zed-extension` | Superfícies de produto e editor que adaptam o Qwen Code aos seus ambientes host.                                                                                                             |
