...
| Camada de transcrição de UI compartilhada | `DaemonUiEventType`, `DaemonSessionProvider`, `packages/web-shell/client/daemon/`                                                                                                                                                                                             | [`13`](./13-sdk-daemon-client.md), [`14`](./14-cli-tui-adapter.md), [`../daemon-ui/README.md`](../daemon-ui/README.md) |
...
| Capacidades   | `SERVE_PROTOCOL_VERSION = 'v1'`; tags registradas e condicionais são definidas pelo registro autoritativo.                                                                                             | [`11`](./11-capabilities-versioning.md)                                                                         |
...
| Consumidor daemon da Web Shell       | `packages/web-shell/client/daemon/` consome o store de transcrição do SDK por meio de providers e adapters React.                                                         | [`14`](./14-cli-tui-adapter.md), [`../daemon-client-adapters/web-shell.md`](../daemon-client-adapters/web-shell.md)                                 |
