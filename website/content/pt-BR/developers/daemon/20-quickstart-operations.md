...
| `--memory-budget-mb <n>`                | integer em `[1024, 1048576]`   | 50% da memória do cgroup/host                    | Somente observação                       | Orçamento total de memória para a árvore de processos do daemon, limitado à memória disponível resolvida. Reportado em `limits.memory`; não dimensiona nenhum filho.                                                                                                                                                   |
