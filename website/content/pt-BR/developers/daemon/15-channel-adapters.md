...
| `multiSession`                           | Tarefas nomeadas apenas do daemon para `sessionScope: 'user'`. O catálogo do proprietário é persistido abaixo do diretório de estado do workspace/canal; webhooks, backfill de histórico de grupo, loops, troca de tarefa em execução e worktrees por tarefa são excluídos na Parte 2. |
