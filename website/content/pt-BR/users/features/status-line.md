...
- O [`jq`](https://jqlang.github.io/jq/) é recomendado para fazer o parsing do JSON de entrada (instale via `brew install jq`, `apt install jq`, etc.)
...
| `command`         | string      | Sim         | Comando de shell a ser executado. Recebe JSON via stdin; o stdout é exibido (até 2 linhas).                                           |
...
| Dados desatualizados              | Nenhum gatilho foi disparado       | Envie uma mensagem ou alterne de modelo para disparar uma atualização — ou defina `refreshInterval` para reexecutar o comando em um timer                                                                                                                                                                                                                                                                                       |
