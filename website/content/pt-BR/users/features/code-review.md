...
| ------------------------------------ | ------------------------------ | --------------------------------------------------------------------------------------------------------------- |
| Agentes de revisão (Etapa 3)         | 16 (+0-2)                      | Executados em paralelo; Agente 1e apenas quando o diff sinaliza um tipo de wrapping (15 sem ele); entre repositórios ignora Agentes 1c e 7 (14), local/arquivo ignora Agente 0 (15) |
...
| **Total**                            | **~19-30 (~17-29)**            | 3A mesmo repositório: ~19-30 (típico ~19-21); entre repositórios ou local/arquivo: ~17-29; um a menos quando o Agente 1e não está na lista; 3B escala com chunks (ver DESIGN.md) |
