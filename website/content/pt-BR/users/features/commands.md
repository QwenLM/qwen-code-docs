...
| Processamento Padrão de Parâmetros | Sem marcação especial | Comandos simples, concatenação de parâmetros | Anexa conforme está                    |
...
Revise {{args}}, referência aos padrões:
