...
| `--output-style`             | Estilo de saída para esta execução (`Concise`, `Proactive`, `Explanatory`, `Learning` ou `default` para nenhum); sobrescreve `general.outputStyle`                                                                                                                                                                                                                                                                                 | `qwen -p "query" --output-style Concise`                                 |
