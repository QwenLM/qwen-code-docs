...
- [Configuração de API](./showcase/guide-api-setup) — Configure a chave API e parâmetros do modelo para personalizar sua experiência de programação com IA
- [Instalação com script em um clique](./showcase/guide-script-install) — Instale rapidamente Qwen Code através de comandos de script
