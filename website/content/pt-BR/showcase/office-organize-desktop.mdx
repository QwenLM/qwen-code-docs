...
- [Organização em Lote de Arquivos](./office-batch-file-organize.mdx) — Processe múltiplas operações de arquivo de uma vez
- [Escrever Arquivo com Uma Frase](./office-write-file.mdx) — Crie novos arquivos rapidamente
