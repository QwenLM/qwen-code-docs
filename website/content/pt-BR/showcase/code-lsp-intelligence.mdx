...
<ShowcaseDetailMeta category="Programação" features={["LSP"]} model="qwen3.5-plus" />
...
- [Integração com VS Code](./guide-vscode-integration.mdx) — Usar o Qwen Code no VS Code
- [Aprendizado de Código](./study-learning.mdx) — Aprender novas bases de código com IntelliSense
