...
<ShowcaseDetailMeta category="Guia de Início" features={["Modo Plan"]} model="qwen3.5-plus" />
...
- [Modo Plan + Pesquisa Web](./plan-with-search) — Combine com Pesquisa Web para lidar com tarefas complexas que requerem as últimas informações
