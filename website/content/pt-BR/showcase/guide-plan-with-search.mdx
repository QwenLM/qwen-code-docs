...
<ShowcaseDetailMeta category="Guia de Início" features={["Modo Plan", "Pesquisa Web"]} model="qwen3.5-plus" />
...
- [Pesquisa Web](./guide-web-search.mdx) — Obter as últimas documentações técnicas e soluções em tempo real
- [Bailian Coding Plan](./guide-bailian-coding-plan.mdx) — Capacidades de planejamento exclusivas para a plataforma Bailian
