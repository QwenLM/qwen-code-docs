...
- [Pesquisa Web](./guide-web-search.mdx) — Pesquise materiais relacionados e informações de fundo
- [Aprender Código](./study-learning.mdx) — Aprenda a implementação de código do artigo
