---
title: "Qwen Code Semanal: Agent Skills GA, Instalação em Um Clique, Exportação de Sessão"
date: "2026-02-09"
description: "Esta semana lançamos as versões estáveis v0.9.0, v0.9.1 e a prévia v0.10.0. Agent Skills removeu o flag experimental, adicionou script de instalação em um clique e recurso de exportação do histórico de sessões."
author: "Qwen Team"
