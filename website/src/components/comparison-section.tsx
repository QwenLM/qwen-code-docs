...
const comparisonFeatures = [
  {
    ...
    features: [
      ...
      { name: "File System Ops", qwen: true, claude: true },
      { name: "Shell Execution", qwen: true, claude: true },
      { name: "Web Scraping", qwen: true, claude: true },
      { name: "SubAgent Support", qwen: true, claude: true },
      { name: "Plan Mode", qwen: true, claude: true },
    ],
  },
  {
