...
import { Cpu, Layers, Shield, Layout } from "lucide-react";
...
const features = [
  {
    ...
    description:
      "Deep integration with Qwen3-Coder models, providing superior code understanding and generation capabilities specifically for large-scale projects.",
  ...
  },
  {
    ...
    description:
      "Built-in support for Skills, SubAgents, and Plan Mode. Orchestrate multiple agents to handle complex refactoring and feature development.",
  ...
  },
  {
    ...
    title: "IDE Friendly",
    description:
      "While terminal-first, Qwen Code optionally integrates with VS Code, Zed, and JetBrains IDEs to fit perfectly into your existing environment.",
      ...
      <div className='container mx-auto px-6 relative z-10'>
        <div className='text-center mb-20'>
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed'>
            Powered by Qwen3-Coder. Multi-agent workflows. 1,000 free
            requests/day. IDE-ready.
          </p>
        </div>
            ...
            >
              ...
              <div className='relative h-full bg-card/80 backdrop-blur-sm rounded-[23px] p-10 flex flex-col items-start border border-border'>
                ...
                <div className='relative mb-8'>
                  <div
                    className={`absolute inset-0 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${feature.accent}`}
                  />
                  <div
                    className={`relative w-14 h-14 ${feature.accent} rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-500 ring-1 ring-border`}
                  >
